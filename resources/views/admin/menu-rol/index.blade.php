...
@section("scripts")
<script src="{{asset("assets/pages/scripts/admin/menu_rol/index.js")}}" type="text/javascript"></script>
@endsection
                    ...
                    <tbody>
                        ...
                        @endif
                            ...
                            @foreach($menu["submenu"] as $key => $hijo)
                                <tr>
                                    <td class="plm-20"><i class="fa fa-arrow-right"></i> {{ $hijo["nombre"] }}</td>
                                    @foreach($rols as $id => $nombre)
                                        <td class="text-center">
                                            <input
                                            type="checkbox"
                                ...
                                @foreach ($hijo["submenu"] as $key => $hijo2)
                                    <tr>
                                        <td class="plm-30"><i class="fa fa-arrow-right"></i> {{$hijo2["nombre"]}}</td>
                                        @foreach($rols as $id => $nombre)
                                            <td class="text-center">
                                                <input
                                                type="checkbox"
                                    ...
                                    @foreach ($hijo2["submenu"] as $key => $hijo3)
                                        <tr>
                                            <td class="plm-40"><i class="fa fa-arrow-right"></i> {{$hijo3["nombre"]}}</td>
                                            @foreach($rols as $id => $nombre)
                                            <td class="text-center">
                                                <input
                                                type="checkbox"
